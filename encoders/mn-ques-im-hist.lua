...
function encoderNet.model(params)
    ...
    local qi = nn.JoinTable(1,1)({q3,img_feats})
    local qi_proj = nn.Tanh()(nn.Linear(params.imgFeatureSize + params.rnnHiddenSize, params.rnnHiddenSize)(qi))

    -- View as batch x rounds
    local qEmbedView = nn.View(-1, params.maxQuesCount, params.rnnHiddenSize)(qi_proj)
